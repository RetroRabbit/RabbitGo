...
struct Style {
    ...
    static let avenirh_xsmall_white_center = [NSForegroundColorAttributeName:Style.color.white, NSFontAttributeName: ProjectRFont.AvenirLightOblique(with: 8), NSParagraphStyleAttributeName: center]
