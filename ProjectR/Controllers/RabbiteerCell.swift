...
//  ProjectR
//
//  Created by Wesley Buck on 2017/07/30.
...
class RabbiteerCell: UITableViewCell {
    /* State */
    class var reuseIdentifier: String { return "RabbiteerCell" }
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        lblFullname.lineBreakMode = .byTruncatingTail
    ...
    func prepareForDisplay(object: Leader) {
        ...
        if object.currentUser {
            ...
            lblQuestionsAnswered.attributedText = NSAttributedString(string: "\(min(object.questionsAnswered, 21))", attributes: Style.avenirh_extra_large_grey_dark_right)
        } else {
            ...
            lblQuestionsAnswered.attributedText = NSAttributedString(string: "\(min(object.questionsAnswered, 21))", attributes: Style.avenirh_extra_large_white_right)
        }
    }
